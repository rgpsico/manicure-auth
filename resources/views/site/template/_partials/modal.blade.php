      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">
              <img src="{{url("assets/site/images/close.png")}}"  alt="Classified Plus"></span> </button>
        </div>
        <div class="modal-body">
        <div class="list-unstyled list-inline social-login">
        <a href="#" class="facebook"> <img src="{{url("assets/site/images/fb.png")}}" alt="Classified Plus">Continue wiith Facbook</a>
        <a href="#" class="google"> <img src="{{url("assets/site/images/google_p.png")}}" alt="Classified Plus"> <span>Continue with Google</span></a>
        </div>
        ...
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
              <span aria-hidden="true">
                  <img src="{{url("assets/site/images/close.png")}}" alt="Classified Plus"></span> 
            </button>
        </div>
        <div class="modal-body">
        <div class="list-unstyled list-inline social-login">
