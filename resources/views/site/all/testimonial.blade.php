<section class="testimonial p-b-40">
  ...
  <li>
                    <div class="testimonials-parts"> <img src="{{url("assets/site/images/John-Peter.png")}}" alt="Classified Plus"/>
                      <div class="testimonials-text">
                        <h3 class="w-25 p-b-10 m-b-10"> John Peter </h3>
  ...
  <li>
                    ...
                    <div class="testimonials-parts"> <img src="{{url("assets/site/images/Williams-Sherry.png")}}" alt="Classified Plus"/>
                      <div class="testimonials-text">
                        <h3 class="w-25 p-b-10 m-b-10"> John Peter </h3>
                        <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
                        <div class="soical-icon ">
